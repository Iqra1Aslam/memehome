...
//   useEffect(() => {
//     // Simulate loading delay - in real app, this would depend on data fetching
//     setIsLoading(true);
...
//       const cardToShuffle = updatedCoins.splice(randomIndex, 1)[0];
//       const newPosition = Math.floor(Math.random() * updatedCoins.length);
//       updatedCoins.splice(newPosition, 0, cardToShuffle);
...
//   // Filter regular coins (market cap ≤ $4000)
//   const regularCoins = coins.filter(
