...
//     {isBuyActive ? (
//       <>
//         <AmountButton label="0.1 SOL" onClick={() => handlePresetAmount("0.1")} />
//         <AmountButton label="0.5 SOL" onClick={() => handlePresetAmount("0.5")} />
//         <AmountButton label="1 SOL" onClick={() => handlePresetAmount("1")} />
//         <AmountButton label="max" onClick={() => handlePresetAmount(balance.toString())} />
//       </>
//     ) : (
//       <>
//         <AmountButton label="10%" onClick={() => handlePresetAmount((tokenBalance / 10).toString())} />
//         <AmountButton label="25%" onClick={() => handlePresetAmount((tokenBalance / 4).toString())} />
//         <AmountButton label="50%" onClick={() => handlePresetAmount((tokenBalance / 2).toString())} />
//         <AmountButton label="max" onClick={() => handlePresetAmount(tokenBalance.toString())} />
//       </>
//     )}
//   </div>
// );
