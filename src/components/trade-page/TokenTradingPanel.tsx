...
import { channel } from "./ablyClient"
    ...
    try {
      ...
      if (tokenData.bondingCurve && tokenData.token) {
        ...
        if (bondingCurveBalance > 0) {
          ...
          console.log("lastValidProgressRef.current", lastValidProgressRef.current)
          setBondingCurveProgress(progressPercentage);
        } else {
          // If realTokenReserves is 0, use the last saved progress
          setBondingCurveProgress(lastValidProgressRef.current);
          console.log("Using last saved progress:", lastValidProgressRef.current);
        }
  ...
  return (
    ...
    >
      ...
      <ProgressBar
        ...
        msg={`there is ${msg.toFixed(2)} SOL in the bonding curve.`}
